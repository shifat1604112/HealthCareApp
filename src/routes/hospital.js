                ...
                <Paper>
                    <Box m={2} p={5}  alignItems="center" >
                        ...
                        <Box display="flex" alignItems="center" justifyContent="center" mb={1}>
                            <Button onClick={this.onOtherRecordSubmit} variant="contained" style={{backgroundColor:"floralwhite",color:"green"}}>Submit</Button>
                        </Box>
                    </Box>
                </Paper>
                </Grid>
    ...
    render(){
        return(
            ...
            <Box m={1}>
                ...
                <Box m={5} sx={{ width: 350,height:100}}><Card>Hospital Account Address:{"\t"+this.state.account}</Card></Box>
                <Box m={3}>
