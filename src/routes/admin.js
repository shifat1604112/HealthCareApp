...
class Admin extends Component{
    ...
    async componentWillMount() {
        ...
        let own = await this.DMR.methods.owner().call(); //owner er address nicchi
                ...
                <Grid container justify="center">
                    <Grid item>
                        ...
                        <Box p={2}>
                            ...
                            <Box m={0.3}>
                                <TextField label="Wallet Address" onChange={this.onaddrChange}></TextField>
                            </Box>
                            <Box m={0.3}>
    ...
    addremoveAdmin=(owner,account)=>{
        return (
            <Box mt={7}>
                <Box m={5} sx={{ width: 350,height:100}}><Card>Current Account Address:{"\t"+account}</Card></Box>
                ...
                <Box m={1}>
                    <Grid container justify="center" spacing={3}>
                        <Grid item>
                            <Chip label="Add Hospital" style={{backgroundColor:"#CCF3EE", color : "black"}} onClick={async ()=>{
                                await this.setState({viewH:false,addview:true,load:false});
                            }}></Chip>
                        </Grid>
                        <Grid item>
                            <Chip label="View Hospital" style={{backgroundColor:"#F9CEEE", color : "black"}} onClick={async ()=>{
